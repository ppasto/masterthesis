...
% }
% 
% # you should use dgamma() because THEORETICAL
% # tvector
% # dgamm (tvector, etc....)
...
% }
% 
% # here you have to use theoretical gamma-gamma!!!
% # derive first with integrals and have a lookt at sabanes bove
% v_lambda <- rgamma(n, shape = alpha, rate = beta)
% tval <- numeric(n)
% 
% for (i in 1:n) {
