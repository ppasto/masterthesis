...
We generalized the notion of patient leakage found in trial profiles such as \ref{fig:2_0}. We conceptualized the different stages in a clinical trial and studied the different reasons why we find patient attrition when moving to the following stage in a study.
