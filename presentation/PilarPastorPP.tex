...
Poisson & $C(t) \sim \rm{Po} (\lambda  t)$ & $\lambda  t$ & $\lambda  t$ & Yes & No \\
Negative Binomial & $C(t) \sim \rm{Po} (\Lambda  t)$; $\Lambda \sim \rm{G}(\alpha,\beta)$ & $\frac{\alpha}{\beta}$ & $\frac{\alpha(\beta+1)}{\beta^2}$ & Yes & Yes \\
\end{tabular}
}
...
\begin{frame}{Comparison between Poisson and Negative Binomial - PMF}


\end{frame}

\begin{frame}{Comparison between Poisson and Negative Binomial - CDF}
