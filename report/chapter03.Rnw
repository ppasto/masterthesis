...
\hline
\hline
 $C(Ttarget)\sim\textrm{Po}(\lambda Ttarget)$ & $\textrm{P}(C(Ttarget)\geq 324) = \Sexpr{round(mean(final_counts_p>324),3)}$ & \Sexpr{round(sqrt(mean(final_counts_p>324)*(1-mean(final_counts_p>324))/10^5), 3)} & \Sexpr{round(1-ppois(324, lambda*550),3)} \\
