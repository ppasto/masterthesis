...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'lambda' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in axis(1, at = seq(1, length(200:500), by = 50), labels = seq(200, : plot.new has not been called yet}}\end{kframe}
\end{knitrout}
