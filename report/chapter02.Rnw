...
For Version 2 of generating $\Lambda^*$ with $T(c)|\Lambda^*\sim\textrm{G}(c,\Lambda^*)$ and $\Lambda^*\sim \textrm{G}(t\alpha,\beta)$ (see Figure \ref{fig:2_14}), we have as expectation and variance:
